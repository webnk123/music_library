...
schema_view = get_schema_view(
   openapi.Info(
      ...
      description="api for CRUD operations on artists, albums and songs, has 3 non generic views. 1. for getting all songs in an album 2. to get all albums by author 3. to add or remove existing song from an album (with serial number)",
